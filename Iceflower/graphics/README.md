...
To edit and export you need: A Vector Programm like Inkscape (others are possible too) and GIMP and if you want them with RE style you need the re-icon fu-script from Unnamed (not everything needs RE style e.g. sky, notexture or others)
...
3. If its necessary use "Colours" -> "Colour to Alpha" and choose black (html notation: 000000) to get only a white image with a transparency background
4. Use "Filters" -> "Alpha to Logo"
(5):!HINT!: Sometimes there are "name_part1.svg" and "name_part2.svg" here you need NOT the "name.svg" only the partX data, make them both to RE-style and combine them after it. (more 3D effect)
...
License: Red Eclipse General License
